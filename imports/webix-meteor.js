...
webix.proxy.meteor = {
	...
	parseSource:function(){
		...
		if (typeof this.source == "object"){
			if (this.source instanceof Mongo.Collection){
				this.collection = this.source;
				this.cursor = this.collection.find();
			} else if (this.source instanceof Mongo.Collection.Cursor){
...
webix.attachEvent("onSyncUnknown", function(target, source){
	if (window.Meteor && source instanceof Mongo.Collection.Cursor){
